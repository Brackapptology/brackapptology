...
export function fetchRPI() {
    return function thunk(dispatch) {
        ...
        return axios.get('/api/espn/rpi/1')
            ...
            .then(res => {
                page6 = res.data;
                return page1.concat(page2).concat(page3).concat(page4).concat(page5).concat(page6);
            })
            .then(() => axios.get('/api/espn/rpi/7'))
            .then(res => {
                page7 = res.data;
                return page1.concat(page2).concat(page3).concat(page4).concat(page5).concat(page6).concat(page7);
            })
            .then(() => axios.get('/api/espn/rpi/8'))
            .then(res => {
                page8 = res.data;
                return page1.concat(page2).concat(page3).concat(page4).concat(page5).concat(page6).concat(page7).concat(page8);
            })
